...
abstract final class LifeContextProjectionFactKeys {
  ...
  static const personRole = 'personRole';
  ...
  static const locationEntityId = 'locationEntityId';
  ...
  static const blocksResponsiblePerson = 'blocksResponsiblePerson';
  static const recurringConsequence = 'recurringConsequence';
    ...
    return switch (purpose) {
      ...
      LifeContextConsumerPurpose.dashboardAnticipation =>
        LifeContextConsumerContract._(
          schemaVersion: schemaVersion,
          purpose: purpose,
          purposeId: 'dashboard_anticipation.context.v1',
          allowedSections: LifeContextProjectionSectionType.values.toSet(),
          allowedSensitivities: const {
            LifeContextSensitivityLevel.publicTechnical,
            LifeContextSensitivityLevel.ordinaryPersonal,
          ...
          globalBudget: 900,
          sectionBudgets: const {
            LifeContextProjectionSectionType.human: 180,
            LifeContextProjectionSectionType.identity: 10,
            LifeContextProjectionSectionType.event: 220,
            LifeContextProjectionSectionType.task: 180,
            LifeContextProjectionSectionType.routine: 120,
            LifeContextProjectionSectionType.memory: 80,
            LifeContextProjectionSectionType.shopping: 50,
            LifeContextProjectionSectionType.relation: 60,
          },
          pastWindow: const Duration(days: 1),
          futureWindow: const Duration(days: 90),
          includeHistorical: false,
          includeFuture: true,
